...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Blog Category Filter', 'html5blank'),
        'description' => __('This is an area where you can drag in the category widget or create a custom menu for the filter links at the top of the Blox Index Page', 'html5blank'),
        'id' => 'widget-area-1',
